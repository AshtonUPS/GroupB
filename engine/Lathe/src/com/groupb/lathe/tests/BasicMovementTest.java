...
class BasicMovementTest {
	...
	private BasicMovement testBM = new BasicMovement();
	private int cooldown_length = 40;
	
	/*
	 * Tests whether or not the BasicMovement class recognizes that the object
	 * is currently jumping after a single space bar key press.
	 */
	@Test
	public void isJumpingTest()	{
		//initialize the test object
		testObject.addComponent(testBM);
	...
	/*
	 * Tests whether or not the BasicMovement class recognizes that it 
	 * is not jumping by default
	 */
	@Test
	...
	/*
	 * Tests to make sure that the player cannot execute an additional jump
	 * when the object is already executing a jump
	 */
	@Test
	...
	/*
	 * Tests to make sure the object is still in the cool down when it should
	 * be. This test uses 15 game loop cycles, where our cool-down length
	 * is set to 40 cycles.
	 */
	@Test
	...
	/*
	 * Test to make sure that the cool down window is exiting at an appropriate
	 * time after a single space bar press
	 */
	@Test
	...
	/*
	 * Tests whether the cool-down input works if someone is continuously 
	 * mashing the space bar on every game cycle for cooldown_length loops
	 */
	@Test
	...
	/*
	 * Tests whether the cool-down input works if someone is continuously 
	 * mashing the space bar on each game cycle for cooldown_length + 1 loops
	 */
	@Test
